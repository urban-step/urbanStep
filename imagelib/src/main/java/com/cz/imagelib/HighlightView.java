...
class HighlightView {
    ...
    private static final float CORNER_LINE_STROKE_WIDTH = 10;
    ...
    private final Paint handleLinePaint = new Paint();
    ...
    public void setup(Matrix m, Rect imageRect, RectF cropRect, boolean maintainAspectRatio) {
        ...
        handleLinePaint.setColor(Color.WHITE);
        handlePaint.setStyle(Paint.Style.FILL);
        handlePaint.setAntiAlias(true);
        handleLinePaint.setStrokeWidth(outlineWidth * 2);
    ...
    //    canvas.drawCircle(drawRect.left, drawRect.top, handleRadius, handlePaint); //top left
        canvas.drawLine(drawRect.left, drawRect.top+ outlineWidth, drawRect.left + CORNER_LINE_LENGTH, drawRect.top + outlineWidth, handleLinePaint);
        canvas.drawLine(drawRect.left + outlineWidth, drawRect.top, drawRect.left+ outlineWidth, drawRect.top + CORNER_LINE_LENGTH, handleLinePaint);

        //canvas.drawCircle(drawRect.left, drawRect.bottom, handleRadius, handlePaint); //bottom left
        canvas.drawLine(drawRect.left + outlineWidth, drawRect.bottom, drawRect.left + outlineWidth, drawRect.bottom - CORNER_LINE_LENGTH, handleLinePaint);
        canvas.drawLine(drawRect.left, drawRect.bottom - outlineWidth, drawRect.left + CORNER_LINE_LENGTH, drawRect.bottom - outlineWidth, handleLinePaint);


        //canvas.drawCircle(drawRect.right, drawRect.top, handleRadius, handlePaint);//right top
        canvas.drawLine(drawRect.right, drawRect.top + outlineWidth, drawRect.right - CORNER_LINE_LENGTH, drawRect.top + outlineWidth, handleLinePaint);
        canvas.drawLine(drawRect.right - outlineWidth, drawRect.top, drawRect.right - outlineWidth, drawRect.top + CORNER_LINE_LENGTH, handleLinePaint);

        //canvas.drawCircle(drawRect.right, drawRect.bottom, handleRadius, handlePaint);//bottom right
        canvas.drawLine(drawRect.right, drawRect.bottom-outlineWidth, drawRect.right - CORNER_LINE_LENGTH, drawRect.bottom-outlineWidth, handleLinePaint);
        canvas.drawLine(drawRect.right-outlineWidth, drawRect.bottom, drawRect.right-outlineWidth, drawRect.bottom-CORNER_LINE_LENGTH, handleLinePaint);

        canvas.drawLine(drawRect.left + outlineWidth, yMiddle - CORNER_LINE_LENGTH / 2, drawRect.left + outlineWidth, yMiddle + CORNER_LINE_LENGTH / 2, handleLinePaint);
        canvas.drawLine(drawRect.right - outlineWidth, yMiddle - CORNER_LINE_LENGTH / 2, drawRect.right - outlineWidth, yMiddle + CORNER_LINE_LENGTH / 2, handleLinePaint);

        canvas.drawLine(xMiddle - CORNER_LINE_LENGTH / 2, drawRect.top + outlineWidth, xMiddle + CORNER_LINE_LENGTH / 2, drawRect.top + outlineWidth, handleLinePaint);
        canvas.drawLine(xMiddle - CORNER_LINE_LENGTH / 2, drawRect.bottom - outlineWidth, xMiddle + CORNER_LINE_LENGTH / 2, drawRect.bottom - outlineWidth, handleLinePaint);
        /*canvas.drawCircle(drawRect.left, yMiddle, handleRadius, handlePaint); //left middle
        canvas.drawCircle(xMiddle, drawRect.top, handleRadius, handlePaint); //top middle
